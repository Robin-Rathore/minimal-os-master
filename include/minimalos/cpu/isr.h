/** @file : isr.h
 *  @brief: This module provides declarations of functions which initialize
 * 			the Interrupt Descriptor Table and functions which handle ISR and IRQ
 * 			requests.
 *
